...
var UIController = (function(){
    ...
    html = '<div class="item clearfix" id="exp-%id%">' +
            ...
            // Replace the placeholder text with smoe actual data
        ...
        displayMonth: function(){
            ...
            months = ['Januar', 'Februar', 'Mart', 'April', 'Maj', 'Jun', 'Jul', 'Septembar', 'Oktobar', 'Novembar', 'Decembar']
            month = now.getMonth();
...
var appController = (function(budgetCtrl, UICtrl){
    ...
    var setupEventListeners = function() {
        ...
        document.querySelector(DOMStrings.inputBtn).addEventListener('click', addItemCtrl);
